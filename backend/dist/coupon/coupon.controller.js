...
let CouponController = class CouponController {
    ...
    validateCoupon(code, cartTotal, isFirstTimeUser) {
        return this.couponService.validateCoupon(code, parseFloat(cartTotal), isFirstTimeUser === 'true');
    }
    findOne(id) {
...
__decorate([
    ...
    __param(2, (0, common_1.Query)('isFirstTimeUser')),
    __metadata("design:type", Function),
